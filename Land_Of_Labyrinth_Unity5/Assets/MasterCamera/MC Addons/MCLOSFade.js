...
function Update () {
		...
		//fadeHits = Physics.SphereCastAll (camController.cam.transform.position, radius, fadeCastDirection, fadeCastDirection.magnitude, fadeLayer);
		//fadeHits = Physics.CapsuleCastAll(mCamera.transform.position, player.transform.position, radius, fadeCastDirection, fadeCastDirection.magnitude, fadeLayer); 
